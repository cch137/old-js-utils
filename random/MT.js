...
class MersenneTwister {
  ...
  random_int() {
    ...
    if (this.mti >= N) {
      let kk;
      if (this.mti == N+1) this.init_seed(5489);
      for (kk = 0; kk < N - M; kk++) {
  ...
  random_int31() {return (this.random_int() >>> 1)};
  random_incl() {return (this.random_int() * (1.0 / 4294967295.0))};
  random() {return (this.random_int() * (1.0 / 4294967296.0))};
  random_excl() {return (this.random_int() + 0.5) * (1.0 / 4294967296.0)};
  random_long() {return ((this.random_int() >>> 5) * 67108864 + (this.random_int() >>> 6)) * (1.0 / 9007199254740992.0)};
};
